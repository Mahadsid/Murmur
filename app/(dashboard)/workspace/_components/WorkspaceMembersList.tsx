...
//         id: 1,
//         name: "Jon doe",
//         imageUrl: "https://avatars.githubusercontent.com/u/65539715?v=4",
//         email: "jondoe@murmur.in",
//     },
// ]
                ...
                <div key={member.id} className="px-3 py-2 hover:bg-accent cursor-pointer transition-colors flex items-center space-x-3">
                    <div className="relative">
                        <Avatar className="size-8 relative">
                            <Image src={getAvatar(member.picture ?? null, member.email!)} alt="User Image" className="object-cover" fill />
                            <AvatarFallback>
